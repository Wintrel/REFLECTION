...
ColumnLayout {
    ...
    Text {
        text: "Requires a reboot or logout to apply in most cases."
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            Repeater {
                model: [
                    { name: "Integrated", icon: "battery_saver",  desc: "iGPU only"       },
                    { name: "Hybrid",     icon: "device_hub",      desc: "Auto switching"   },
                    { name: "Discrete",   icon: "memory",          desc: "dGPU always on"   }
                ]
                ...
                delegate: Rectangle {
                    ...
                    property bool isCurrent: index === RogService.gpuMode
                    ...
                    MouseArea {
                        ...
                        onClicked: RogService.setGpuMode(index)
                    }
                }
            }
        }
