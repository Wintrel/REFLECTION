...
Item {
    ...
    property var themes: [
        ...
        textMain: "#F0F0F2",
        textSub: "#8A8C94",
        accentNotification: "#1A1B21",
        accentMusic: "#20222B",
        accentWorkspace: "#1A1B21",
        accentPrimary: "#D2DCFF",
        colorSystemShimmer: "#E8ECFF",
        bgBase: "#000000",
        surfaceCard: "#0D0D12",
        surfaceOverlay: "#15161C",
        textMuted: "#54565E",
        accentSecondary: "#BEC8E1",
        useGradients: true,
        bgInnerGradientEnd: "#000000",
        surfaceCardGradientEnd: "#050507",
        accentPrimaryGradientEnd: "#9AA8D8"
        },
        {
            name: "Custom",
            bgBezel: "#000000",
